...
public class NuevaRutinaDTO implements Serializable {
    ...
    public List<Integer> getIdsEjercicios() {
        return idsEjercicios;
    }

    public void setIdsEjercicios(List<Integer> idsEjercicios) {
        this.idsEjercicios = idsEjercicios;
    }

    public List<EjercicioEnRutinaDTO> getEjercicios() {
        return ejercicios;
    }

    public void setEjercicios(List<EjercicioEnRutinaDTO> ejercicios) {
